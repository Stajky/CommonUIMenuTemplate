...
namespace CmtTag
{
	...
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Message_XP);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Message_Health);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Message_Mana);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Message_Spell1);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Message_Spell2);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Message_Spell3);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Message_Spell4);
