...
namespace CmtTag
{
	...
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_Cheat_CallAllSpells);
	
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(GMSChannel_UI_Int);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(GMSChannel_UI_Float);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(GMSChannel_UI_SettingDescribtion);
	
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Message_Level);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Message_XPPercent);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Message_HealthPercent);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Message_ManaPercent);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Message_Spell1Cooldown);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Message_Spell2Cooldown);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Message_Spell3Cooldown);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Message_Spell4Cooldown);
	
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Modal_Confirm);
