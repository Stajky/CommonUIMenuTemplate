...
#include "SCmtSlider.h"
#include "Input/NavigationReply.h"
#include "Misc/App.h"
#include "Input/Reply.h"

void SCmtSlider::Construct(const SCmtSlider::FArguments& InDeclaration)
{
	SetCanTick(false);
	...
	OnFocused = InDeclaration._OnFocused;
	OnUnfocused = InDeclaration._OnUnfocused;
}

FReply SCmtSlider::OnMouseButtonDown(const FGeometry& MyGeometry, const FPointerEvent& MouseEvent)
{
	if (bIsUsingGamepad)
	{
...
FReply SCmtSlider::OnMouseButtonUp(const FGeometry& MyGeometry, const FPointerEvent& MouseEvent)
{
	if (!bIsUsingGamepad)
	{
...
FReply SCmtSlider::OnAnalogValueChanged(const FGeometry& MyGeometry, const FAnalogInputEvent& InAnalogInputEvent)
{
...
FNavigationReply SCmtSlider::OnNavigation(const FGeometry& MyGeometry, const FNavigationEvent& InNavigationEvent)
{
...
void SCmtSlider::SetUsingGamepad(bool InUsingGamepad)
{
	bIsUsingGamepad = InUsingGamepad;
}

FReply SCmtSlider::OnFocusReceived(const FGeometry& MyGeometry, const FFocusEvent& InFocusEvent)
{
	OnFocused.ExecuteIfBound();
	return SSlider::OnFocusReceived(MyGeometry, InFocusEvent);
}

void SCmtSlider::OnFocusLost(const FFocusEvent& InFocusEvent)
{
